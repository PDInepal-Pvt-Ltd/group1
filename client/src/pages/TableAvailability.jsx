...
export default function TableAvailability() {
  ...
  return (
    <section className="relative min-h-screen w-full px-4 py-16 overflow-hidden bg-linear-to-b from-neutral-900 to-black flex flex-col justify-start font-serif">
      {/* Subtle Background */}
      ...
      <div className="relative z-10 mx-auto max-w-6xl w-full">
        ...
        <div className="mb-12 flex flex-col items-center justify-center gap-6 md:flex-row md:justify-between">
          <div className="space-y-2 text-center md:text-left">
            ...
            <p className="text-lg text-neutral-300">Discover and reserve your perfect table</p>
          </div>
          ...
          <div className="flex flex-col items-center gap-4 w-full md:w-auto md:items-end">
            <input
              ...
              className="w-full md:w-72 px-5 py-3 bg-neutral-800/50 border border-neutral-600 rounded-full text-white text-sm placeholder-neutral-400 focus:outline-none focus:border-amber-400 transition-colors shadow-md"
            />
            <div className="flex p-1 bg-neutral-800/50 border border-neutral-600 rounded-full shadow-md">
              {['AVAILABLE', 'ALL'].map((mode) => ( // Reordered for customer priority
                <button
                  ...
                  className={`relative px-6 py-2 text-xs font-semibold tracking-wide transition-all rounded-full ${
                    filter === mode ? 'text-black bg-amber-300' : 'text-neutral-300 hover:text-white'
                  }`}
            ...
            <AnimatePresence mode="popLayout">
              {filteredTables.map((table) => (
                <motion.button
                  ...
                  className="group relative flex flex-col justify-between h-72 overflow-hidden rounded-3xl border border-neutral-700/50 bg-neutral-800/30 backdrop-blur-lg p-6 transition-all hover:border-amber-400/50 hover:bg-neutral-800/50 hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-amber-400 focus:ring-offset-2 focus:ring-offset-black cursor-pointer"
                  aria-label={`View details for ${table.name}`}
                >
                  <div className="flex justify-between items-start">
                    <div>
                      <h3 className="text-3xl font-light text-white tracking-wide">{table.name}</h3>
                    ...
                    <div className={`px-4 py-1.5 rounded-full text-xs font-semibold tracking-wide border ${
                      ...
                      'border-neutral-400/50 text-neutral-300 bg-neutral-400/10'
                    }`}>
                      {table.status}
                    </div>
                  </div>
                  ...
                  <div className="my-8 text-center">
                    <Users size={48} className="mx-auto text-neutral-400 group-hover:text-amber-300 transition-colors" />
                    <span className="block mt-2 text-xl font-medium text-white">{table.seats} Seats</span>
                  </div>

                  <div className="flex items-center justify-center pt-4 border-t border-neutral-700/50">
          ...
          {selectedTable && (
            ...
            >
              <motion.div
                ...
                className="w-full max-w-3xl bg-neutral-900/95 backdrop-blur-xl border border-neutral-700 rounded-3xl shadow-2xl p-8 lg:p-10 overflow-y-auto max-h-[90vh]"
              >
                <div className="flex justify-between items-start mb-6">
                  <h3 className="text-4xl font-light text-white tracking-wide">{selectedTable.name}</h3>
                  <button onClick={() => setSelectedTable(null)} className="text-neutral-400 hover:text-amber-300 p-2 rounded-full focus:outline-none focus:ring-2 focus:ring-amber-400" aria-label="Close modal">
                    <X size={24} />
                  </button>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-6">
                    <div>
                      <h4 className="text-lg font-medium text-neutral-300 mb-1">Status</h4>
                    ...
                    <div>
                      <h4 className="text-lg font-medium text-neutral-300 mb-1">Capacity</h4>
                    ...
                    {selectedTable.location && (
                      <div>
                        <h4 className="text-lg font-medium text-neutral-300 mb-1">Location</h4>
                        <div className="flex items-center gap-2 text-white">
                          <MapPin size={20} />
                  ...
                  {/* QR Code */}
                  <div className="flex flex-col items-center justify-center p-6 bg-neutral-800/50 rounded-2xl border border-neutral-700">
                    <h4 className="text-lg font-medium text-neutral-300 mb-4">Digital Menu</h4>
                    {selectedTable.qrCodeUrl ? (
                      ...
                      <div className="w-40 h-40 flex flex-col items-center justify-center bg-neutral-800 text-neutral-400 rounded-xl">
                        <QrCode size={48} />
